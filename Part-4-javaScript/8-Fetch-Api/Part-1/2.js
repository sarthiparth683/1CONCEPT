...
fetch("<https://api.example.com/user-details>")
  ...
  .then((data) => {
    console.log(data)    // The second .then() takes the parsed data and logs it.
  })
  .catch((error) => {
    console.error("Error:", error)  // .catch() is used to handle any errors that occur during the fetch.
  });
//----------------------------------------------------------------------------------
