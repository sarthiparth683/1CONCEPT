// Student Activities
// Parsing JSON Data: Practice fetching JSON data from a public API and parsing it using JavaScript.
// Creating JSON Objects: Create a JSON object representing a list of products with attributes such as name, price, and quantity.
// Manipulating JSON Data: Write JavaScript code to modify the values of specific keys in a JSON object and display the updated data.
// Conclusion
// In conclusion, JSON is a versatile data format widely used in web development for transmitting and storing structured data. Understanding JSON is essential for working with APIs, managing data in web applications, and facilitating communication between server-side and client-side components.
...
// solution :- 
// When storing complex data types like arrays or objects, you need to serialize them into a string using JSON.stringify before storing and deserialize them using JSON.parse when retrieving.
