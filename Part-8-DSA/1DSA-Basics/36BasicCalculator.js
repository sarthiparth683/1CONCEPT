...
// console.log(Number(str)); // 12.78
// console.log(parseFloat(str)); // 12.78
// console.log(parseInt(str)); // 12
// console.log(+str); // 12.78
// console.log(str * 1); // 12.78
// console.log(~~str); // 12
// console.log(Math.floor(str)); // 12
// console.log(Math.round(str)); // 13
// console.log(Math.ceil(str)) // 13
// =============================================================
