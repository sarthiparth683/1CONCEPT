  ...
  switch (userChoice) {
    ...
    case 2:
      ...
      const resultSubtraction =
        userInputSubtraction.firstNumber - userInputSubtraction.secondNumber;
      console.log(
        `${userInputSubtraction.firstNumber} - ${userInputSubtraction.secondNumber} = ${resultSubtraction}`,
      );
    ...
    case 3:
      ...
      const resultMultiplication =
        userInputMultiplication.firstNumber *
        userInputMultiplication.secondNumber;
      console.log(
        `${userInputMultiplication.firstNumber} * ${userInputMultiplication.secondNumber} = ${resultMultiplication}`,
      );
    ...
    case 4:
      ...
      const resultDivision =
        userInputDivision.firstNumber / userInputDivision.secondNumber;
      console.log(
        `${userInputDivision.firstNumber} / ${userInputDivision.secondNumber} = ${resultDivision}`,
      );
