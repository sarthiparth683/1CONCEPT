function calculateSimpleInterest(principalAmount, interstRateYearly, durationInYears) {
  let simpleInterest = (principalAmount * interstRateYearly * durationInYears) / 100;
