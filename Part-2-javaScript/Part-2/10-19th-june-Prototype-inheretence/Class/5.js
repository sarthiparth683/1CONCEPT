...
console.log(p1);
console.log(p1.canSleep()); // inside prototype
console.log(Person.greet());  // static greet is inside prototype then in constructor
//----------------------------
...
console.log(e1);
e1.salary = 44000;
console.log(e1.salary); //salary updated - get and set method inside prototype is saved
