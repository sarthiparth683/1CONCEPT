...
let Account1 = account(1290337843, 'Vivek', 'Savings', 90000, true);
let Account2 = account(4857544844, "Achiles", "current", 548912, true);
...
let animal11 = animal(4, true);
console.log(animal1)

let animal22 = animal(6, false);
console.log(animal2)
animal2.eat() // eating...
