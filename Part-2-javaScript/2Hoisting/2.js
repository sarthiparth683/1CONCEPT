...
//  `let` and `const` are also hoisted, but they are in a “temporal dead zone (TDZ)” — meaning they can’t be accessed before their declaration line. Accessing them before declaration causes a ReferenceError.
// ----------------------------------------------------------------------------------------------------------------
